...
<nav class="navbar navbar-light navbar-expand-lg bg-light shadow">
   ...
   <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b><?php if (isset($_SESSION["name"])) {
				...
				<li>
					 <div class="row">
                        ...
                        if(isset($_SESSION["email"]) and isset($_SESSION["name"])){
                              ...
                              //</div>
                              //</div>";
                              echo "<p class=\"m-3\">Connecté en tant que ".$_SESSION["name"]."</p>
                       ...
                       <div class=\"bottom text-center\">
                          Nouveau ? <a href=\"#\"><b>Inscription</b></a>
                       </div>";
                  }
                         ?>
